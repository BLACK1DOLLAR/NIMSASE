  ...
  try {
    ...
    if (evtCount === 0) {
      await Event.insertMany([
        ...
        { title: 'NiMSA South-East Regional Convention 2025', date: '2025-11-02', time: '09:00', type: 'Convention', location: 'Enugu State University of Science & Technology (ESUMSA)', description: 'Hosted by ESUMSA, featuring the first-ever NiMSA South-East Debate Tournament, academic competitions, and the regional awards night.', status: 'past' },
      ]);
    ...
    if (newsCount === 0) {
      await News.insertMany([
        { title: 'NiMSA SE Wins Ever Solid Region Award at National Convention', category: 'Achievement', date: '2026-03-01', excerpt: 'The South East Region has once again been recognized as the Ever Solid Region of NiMSA, marking three consecutive years of excellence.', content: 'The South East Region has once again been recognized as the Ever Solid Region of NiMSA at the national convention.', featured: true },
        ...
        { title: 'GOUMSA Students Sweep Awards at 2025 NiMSA South-East Convention', category: 'Achievement', date: '2025-11-02', excerpt: 'Godfrey Okoye University medical students were recognised across multiple categories at the regional convention hosted by ESUMSA, including the debut of the South-East Debate Tournament.', content: 'At the 2025 NiMSA South-East Regional Convention hosted by ESUMSA at Enugu State University of Science & Technology, Godfrey Okoye University (GOUMSA) students were honoured with several regional awards: Academic Mentor of the Year, Trailblazer in Leadership, Political Personality of the Year, Pacesetter Award, Most Social South-East NiMSAite, and Face of the NiMSA South-East Region. The convention also featured the first-ever NiMSA South-East Debate Tournament.', featured: false },
      ]);
